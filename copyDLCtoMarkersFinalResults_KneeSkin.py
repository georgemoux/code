    ...
    try: # might need to add a try/os.error b/c it's looking for mfr.csv 
        ...
        #     #Compare likelihood, should be above 95%
            ...
            #     #First marker cam3 y,x
                ...
                Final_Results[l+0,3] =  cam3csv.iat[l,5]
                Final_Results[l+0,4] =  2048- cam3csv.iat[l,4]
            # else:
            ...
            # if cam4csv.iat[l,3] > 0.95:
                Final_Results[l+0,5] =  cam4csv.iat[l,5]
                Final_Results[l+0,6] =  2048- cam4csv.iat[l,4]
            # else:
            ...
            # if cam3csv.iat[l,6] > 0.95:
                Final_Results[l+0,7] =  cam3csv.iat[l,8]
                Final_Results[l+0,8] =  2048-cam3csv.iat[l,7]
            # else:
            ...
            # if cam4csv.iat[l,6] > 0.95:
                Final_Results[l+0,9] =  cam4csv.iat[l,8]
                Final_Results[l+0,10]=  2048-cam4csv.iat[l,7]
            # else:
